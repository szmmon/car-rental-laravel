                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('cars.update', $car->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="price" type="number" step="0.01" min="0" class="form-control" name="price" value="{{$car->daily_price}}" >  
                            </div>
                        </div>
                        
                            <div class="row mb-3">
                            <div class="col-md-3"></div>
                            <label for="image" class="col-md-3 text-center col-form-label text-md-end">Image</label>
                                    <div class="row">
                                    <div class="col-md-2"></div>
                                    <div class="col-md-8">
                                    @if(!is_null($car->image_path))
                                    <img src="{{asset('storage/' . $car->image_path)}}" alt="No product image" class="img-thumbnail mx-auto d-block sm">
                                    @endif
                                    </div>
                                    </div>
